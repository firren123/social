...
class LinkPager extends Widget
{
    ...
    /**
     * @var bool 是否使用自定义样式1 //z20150420
     */
    public $_is_custom_style_1 = false;
    ...
    protected function renderPageButton($label, $page, $class, $disabled, $active)
    {
        ...
        //z20150420 自定义样式1
        if ($this->_is_custom_style_1 === true) {
            $html_a = '';
            $html_a .= "<a href=\"#\" class=\"zjs_btn_page\">";
            $html_a .= "<span class=\"zjs_text_page\">" . (intval($page) + 1) . "</span>";
            $html_a .= "<span class=\"zjs_btn_page_num\" style=\"display:none;\">" . (intval($page) + 1) . "</span>";
            $html_a .= "</a>";
            return Html::tag('li', $html_a, $options);
        }
